...
\begin{table}[H]
    ...
    \centering
     \begin{tabular}{||c c c||} 
     \hline
     \textit{\textbf{Average Turnaround Time}} & \textit{\textbf{Average Waiting Time}} & \textit{\textbf{Throughput}}\T \B \\ 
     \hline
     \hline
     1 & 0 & 60 \T \B \\ 
     \hline
...
In this experiment, the proposed algorithm results are compared against both a static and a dynamic version of the RR algorithm addressed in \cite{b1}. 
...
\begin{table}[H]
    ...
    \cline{2-3}
    \cline{2-3}
    \multicolumn{1}{c||}{} & \textit{\textbf{Average Turnaround Time}} & \textit{\textbf{Average Waiting Time}}\T \B \\
    \hline
    \multicolumn{1}{||c}{\textit{\textbf{Proposed Algorithm}}} & 115 & 68.8 \T \B\\ \hline
    \multicolumn{1}{||c}{\textit{\textbf{Static RR}}} & 161.4 & 116.2 \T \B\\ \hline
    \multicolumn{1}{||c}{\textit{\textbf{Dynamic RR}}} & 150.8 & 107.6\T \B\\ \hline
     \end{tabular}
\end{table}
